...
export default function Login() {
  ...
  return (
    <ScrollView style={styles.bodyContainer}>
      ...
      <Text style={{fontSize:20,color:'white'}}>Sign In to Green Bangla</Text>
      ...
      <TextInput
        ...
        <TextInput
            ...
            style={styles.input}
            />
        <TouchableOpacity onPress={() => router.push({ pathname: "/forgetpassword" })}>
            <Text style={{color:'#F6B426',alignSelf:'flex-end',fontSize:13,marginTop:10}}>Forget Password?</Text>
        </TouchableOpacity>
      {/* Submit Button */}
